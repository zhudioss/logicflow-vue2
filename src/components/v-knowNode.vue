...
export default {
  ...
  mounted() {
    console.log(document.querySelector('.know-class').offsetHeight,'--------')
    this.bus.$emit('v-know', {
      type: "knowNode",
      width: document.querySelector('.know-class').offsetWidth,
      height: document.querySelector('.know-class').offsetHeight,
    })
  },
  methods: {}
}
